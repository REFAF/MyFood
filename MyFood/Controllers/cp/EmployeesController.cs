...
namespace MyFood.Controllers.cp
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Emp_id,Emp_name,mobile,role_id")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Emp_id,Emp_name,mobile,role_id")] Employee employee)
        {
            if (ModelState.IsValid)
            {
